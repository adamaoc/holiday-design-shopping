...
<div class="container <?php echo $onpage; ?>">
	
	<div class="row">
			<div class="module">
				<div class="container">
					<h3>About Holiday Design</h3>
					...
					<p>If you have an questions or concernes please do not hesitate to shoot us a message on our <a href="/contact/">contact form</a>.</p>
					<p class="btn-padded"><a class="btn btn-primary btn-lg" href="/store/categories/">Go Shopping &rarr;</a></p>
